    ...
    return (
        <div className='lg:h-[80vw] h-[250vw]  text-white/50 w-full p-[8vw] flex mb-[2vw] relative'>
            ...
            <div className='-h-full lg:w-1/2 w-full flex flex-col gap-[1vw]'>
                ...
                <div className='text-white/50 flex w-full gap-[21.5vw] mt-[4vw] lg:block hidden'><i class="ri-shining-fill"></i> <i class="ri-shining-fill"></i></div>
               
                <div className=' text-white flex w-full gap-[19vw] lg:mt-0 mt-[9vw]'>
                ...
                <div className='lg:leading-tight leading-[11vw] lg:mt-0 mt-[25vw]'>
                    <h1 className='lg:text-[7vw] text-[14vw] text-white/60 font-medium mt-[1vw]'>PrideDesk</h1>
