...
const Pricing = () => {
    ...
    return (
        <div className='main6 lg:h-[60vw] h-[340vw] w-full relative  rounded-2xl px-[7vw] py-[5vw]'>
            ...
            <div className='lg:h-[19vw] h-[210vw] w-full text-white  flex lg:flex-row flex-col gap-1.5 '>
                ...
                <div className='lg:h-full lg:w-[57vw] h-[120vw] w-full lg:bg-white/30 bg-black rounded flex flex-col lg:gap-0 gap-2'>
                    ...
                    <div className='h-1/2 w-full p-[2vw] pt-[2vw]  flex lg:flex-row flex-col lg:items-end items-start justify-between'>
                        ...
                        <a className='bg-white/90 text-center rounded-4xl py-2 px-[6vw] font-medium text-black lg:mb-0 mb-[4vw]' href="#contact">Get in touch</a>
                    </div>
                </div>
                ...
                <div className='block lg:hidden lg:h-full lg:w-[21vw] h-[90vw] w-full rounded flex flex-col justify-between p-[2vw]'>
                    ...
                    <div className='flex gap-2 items-center lg:mt-0 mt-[80vw]'>
                        <div onClick={change} className={` transition-all ease duration-75 lg:h-[1.8vw] lg:w-[3vw] h-[7.8vw] w-[14vw] relative cursor-pointer rounded-3xl  flex items-center justify-start px-1 ${active ? ["bg-white/40",] : "bg-orange-800/50"}`}>
                            ...
                            <div className={`absolute transition-all ease duration-75  lg:h-[1.82vw] lg:w-[1.82vw] h-[8.6vw] w-[8.6vw] rounded-full bg-white/40 z-20 right-[-0.5vw] top-[-0.5vw] ${active ? "opacity-0" : "opacity-100"} `}></div>
                        </div>
                        <h3 className='font-semibold text-xl'>+$1,490</h3>
                    </div>
            ...
            <div className='main7 lg:h-[15vw] h-[72vw] w-[93vw]   text-white lg:flex-row flex-col flex px-[4vw] lg:mt-0 mt-[8vw] py-[5vw]'>
                ...
                <div className='absolute h-[20vw] lg:h-full lg:w-3/4 w-[75vw]  lg:right-[23vw] lg:bottom-[10vw] bottom-[85vw] right-[3vw] flex flex-col gap-[0.5vw]   mr-[5vw]'>

                    <h5  className=' lg:text-[2vw] lg:mr-0 mr-[7vw]   text-[4.7vw] text-end leading-none mt-[0.5vw] text-white/50 lg:w-[45vw]'>
                    <span className='text-orange-800/90'>Add marketing, SEO or content creation </span>
                    flexible tools  to strengthen your project. We'll shape a solution that fits your business, not ours</h5>
